...
перед отправкой заявки. Выполненные работы отмечены отдельно.
План предполагает возможность параллельно готовить документы, датасет и интерфейс.
Описание уже написанного кода опубликовано в [first_code.md](../../first_code.md)
21.09.2026. Его подготовка не переносит плановую дату показа кода.
...
| Первый показ кода, рабочая целевая дата             | 05.10.2026 | 05.10.2026 | Показ состояния кода; first_code.md уже подготовлен        |
