...
Ближайшие доступные задачи разработки: A01 (аккаунт и владение),
M01 (набор текстов), R00 (инструменты предпроектного исследования).
P13 также технически доступен, но полный поток P15 ждёт ML и новый owner-контракт.
...
- [ ] **Статус:** todo. **Зависимости:** P10, P12.
