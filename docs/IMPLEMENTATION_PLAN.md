...
Редакция 21.09.2026 после согласования окончательной заявки. Обязательный результат:
...
2. Разрабатывать только в пределах запроса пользователя. Подготовка заявки не запускает код или обучение.
...
Ближайшие доступные задачи при отдельном запросе на код: A01 (аккаунт и владение),
...
Подготовить воспроизводимый показ, first_code.md/second_code.md по фактически пройденным этапам и видео 4–5 работающих сценариев. Не создавать задним числом фиктивное прохождение этапов.
...
### 2026-09-21 — документационная поставка окончательной заявки

Автор согласовал ограниченный объём с обязательным базовым обучаемым текстовым
классификатором и правилами, обычными аккаунтами и демонстрационными операциями.
...
Следующее действие по разработке — A01 или независимая M01 после отдельного запроса.
