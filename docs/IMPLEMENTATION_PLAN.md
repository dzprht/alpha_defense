...
После P13 доступны A01 (аккаунт и владение), M01 (набор текстов) и R00
(инструменты предпроектного исследования). Полный поток P15 ждёт ML и новый
owner-контракт; принятие P13 не заменяет этих зависимостей.
...
- [ ] **Статус:** todo. Зависимости: P03, P05.
