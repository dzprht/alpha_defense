...
Сейчас завершены P01–P10: воспроизводимая среда, общие контракты и границы слоев,
...
ingress_risk_epoch и удерживает analysis_pending одной транзакцией до будущей оценки.
HTTP workflow для приема не опубликован до P15.
...
Завершены P01–P10. Зафиксированы manifests/lock-файлы и проверки Python/Node; реализованы
...
аттестация звонка, публичный workflow приема коммуникаций, анализ риска,
остальные web-экраны, полный scenario
