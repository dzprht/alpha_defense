...
Сейчас завершены P01–P09: воспроизводимая среда, общие контракты и границы слоев,
...
Завершены P01–P09. Зафиксированы manifests/lock-файлы и проверки Python/Node; реализованы
...
аттестация звонка, публичный workflow приема коммуникаций, инциденты, анализ риска,
