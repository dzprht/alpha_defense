...
Сейчас завершены P01–P05: воспроизводимая среда, общие контракты и границы слоев,
техническое хранение, bootstrap, HTTP-контур и synthetic demo-сессии. Точный прогресс, evidence и
...
Завершены P01–P05. Зафиксированы manifests/lock-файлы и проверки Python/Node; реализованы
...
аттестация звонка, анализ риска, web-интерфейс, fixture-сценарии, модели,
