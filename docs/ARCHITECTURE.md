...
Сейчас завершены P01–P11: воспроизводимая среда, общие контракты и границы слоев,
...
для приема не опубликованы до P15.
...
Завершены P01–P11. Зафиксированы manifests/lock-файлы и проверки Python/Node; реализованы
...
warning/guidance, остальные web-экраны, полный scenario
